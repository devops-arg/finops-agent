    ...
    def _list_ec2(self, params: dict) -> dict:
        ...
        instances = [
            ...
            },
            {
                ...
                "state": "running",
                "environment": "production",
                "name": "eks-node-prod-5",
                "role": "eks-node-compute",
                "cpu_pct": 42.3,
                "memory_pct": 28.6,
            },
            {
                ...
                "state": "running",
                "environment": "production",
                "name": "eks-node-prod-6",
                "role": "eks-node-compute",
                "cpu_pct": 38.9,
                "memory_pct": 31.2,
            },
            {
                "instance_id": "i-0a1b2c3d4e5f60007",
                "instance_type": "m5.xlarge",
                "state": "running",
                "environment": "production",
                "name": "eks-node-prod-7",
                "role": "eks-node",
                "cpu_pct": 15.2,
                "memory_pct": 44.7,
            },
            {
                "instance_id": "i-0a1b2c3d4e5f60008",
                "instance_type": "m5.xlarge",
                "state": "running",
                "environment": "production",
                "name": "eks-node-prod-8",
                "role": "eks-node",
                "cpu_pct": 19.8,
                "memory_pct": 39.3,
            },
            {
                "instance_id": "i-0a1b2c3d4e5f60009",
            ...
            {
                "instance_id": "i-0a1b2c3d4e5f60011",
                "instance_type": "t3.large",
                "state": "running",
                "environment": "staging",
                "name": "eks-node-stg-3",
            ...
            {
                "instance_id": "i-0a1b2c3d4e5f60012",
        ...
        avg_cpu = round(
            sum(i["cpu_pct"] for i in instances if i["state"] == "running")
            / max(1, sum(1 for i in instances if i["state"] == "running")),
            1,
        )
        return {
            "instances": instances,
        ...
        return {
            ...
            "buckets": [
                ...
                },
                {
                    ...
                    "environment": "production",
                    "monthly_cost": 110,
                    "alert": "No lifecycle policy — S3-IA transition after 30d would save ~$85/mo",
                },
                {
                    "name": "devopsarg-prod-backups",
                    "size_gb": 380,
                    "objects": 180_000,
                    "lifecycle": True,
